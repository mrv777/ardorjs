...
describe("Ardor functions", function () {
  ...
  describe("verifyTransactionBytes", () => {
    it("should verify created transaction bytes", () => {
      // Generated on http://localhost:26876/test Ardor v2.2.2
      const unsignedTxBytes =
        "";
      ...
      const transactionJSON = {
        ...
        chain: 2,
        signature:
          "e4bc5ba95b69e97bae7e002e2eede9ed7d08c2576387de2ac9dc8bdaaf98e509de8417590eba621e07812b59dd0f5b43deb5332c1dc690427b819977fb5714ca",
        feeNQT: "3000000",
        type: 2,
        fullHash:
          "37b57ad6d27c4e82fd9aab8e57e5e35c8308512f8d0ca04e0a2946680023016a",
        version: 1,
        fxtTransaction: "0",
        phased: false,
        ecBlockId: "17077041588918635027",
        signatureHash:
          "bf7f790999e9a9fa2b81ae73d89b879645fecaff0f7ac19845c5b81244dc3e4f",
        attachment: {
          quantityQNT: "100",
      ...
      expect(
        account.verifyTransactionBytes(
          unsignedTxBytes,
          transactionType,
          transactionJSON,
          PUBLICKEY
